...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "sixtyoneeighty")
if WEBUI_NAME != "sixtyoneeighty":
    WEBUI_NAME += " (sixtyoneeighty)"

WEBUI_FAVICON_URL = "[img]https://i.imgur.com/R1lJKyW.png"
